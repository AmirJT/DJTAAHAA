...
const BlogBio = () => {
  return (
    <motion.section 
      className="relative w-full h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-r from-gray-900 via-black to-gray-900 px-6 md:px-10"
    ...
    >
      ...
      <div className="w-full md:w-1/2 flex justify-center mb-6 md:mb-0">
        ...
        <Image 
          ...
          width={300} 
          height={400} 
          className="rounded-lg shadow-lg md:hidden w-3/4"
        />
      </div>
      
      {/* Right - Bio Content */}
      <div className="w-full md:w-1/2 text-white text-center md:text-left md:pl-10">
        <h1 className="text-4xl md:text-7xl font-extrabold uppercase tracking-wider">About TAAHAA</h1>
        <div className="hidden md:block">
          <p className="text-lg md:text-2xl mt-4 md:mt-6 leading-relaxed">
        ...
        <p className="text-md md:hidden mt-6 leading-relaxed">
